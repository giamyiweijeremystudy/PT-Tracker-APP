...
export default function IpptCalculator() {
  ...
  const graphData = savedResults.map((r,i)=>({ name:fmtDate(r.created_at.slice(0,10), { year: false }), attempt:i+1, total:r.total, pushups:r.pu_pts, situps:r.su_pts, run:r.run_pts }));
